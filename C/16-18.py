...
DATA_FILE = Path(__file__).with_name("maximos_minimos")
OUTPUT_FILE = Path(__file__).with_name("ciclos_a_z_g_filtrado")
PLOT_FILE = Path(__file__).with_name("ciclos_a_z_g_filtrado.png")
...
ax.set_title("Ciclos de aceleração vertical extremos")
ax.set_xlabel("t [s]")
ax.set_ylabel("a_z [g]")
ax.grid(True)
